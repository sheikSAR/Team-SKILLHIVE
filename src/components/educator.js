...
import { Nav, Button, Badge, Tab, Modal } from "react-bootstrap";
...
export const Educator = ({ address, contract, t_contract, ts_contract }) => {
  ...
  }, [contract, id.id]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const uploadCourse = async (e) => {
    ...
    try {
      ...
      form.append("id", parseInt(courseID));
      form.append("description", desc);
      form.append("author", author);
      form.append("author_id", parseInt(authorID));
      form.append("address", address);
      form.append("price", parseInt(price));
      form.append("question", ques);
      form.append("deadline", parseInt(dline));
